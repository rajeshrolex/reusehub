                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex space-x-4">
                            <a
                                href="https://facebook.com/reusehub"
                                target="_blank"
                            ...
                            <a
                                href="https://instagram.com/reusehub"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            <a
                                href="https://twitter.com/reusehub"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            <a
                                href="https://linkedin.com/company/reusehub"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            <a
                                href="https://youtube.com/@reusehub"
                                target="_blank"
                                rel="noopener noreferrer"
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 mb-6">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-400">+91 87909 21442</span>
                            </li>
                            <li className="flex items-start">
                                <svg className="w-5 h-5 mr-3 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
